...
function editMasuk(i) {
    ...
    // 3. Cari nama barang di db.master berdasarkan kode dari transaksi
    ...
    // Set kode ke hidden input
    document.getElementById('in_kode').value = item.kode;
    
    // Set teks ke input search agar user melihat nama barangnya
    ...
    // Opsional: Fokus ke input qty agar user bisa langsung mengetik
...
function editKeluar(i) {
    ...
    // 3. Cari detail nama barang di db.master berdasarkan kode
    const barang = db.master.find(m => m.kode === item.kode);
    ...
    // Sinkronisasi ke input teks (Searchable Select)
    ...
    // 5. Ubah UI
    const title = document.getElementById('titleKeluar');
    const btn = document.getElementById('btnSubmitKeluar');
    
    if (title) title.innerText = "Ubah Data Transaksi Keluar";
    if (btn) btn.innerText = "Perbarui Data";
...
function editRusak(i) {
    ...
    // Set kode ke hidden input (penting untuk simpan data)
    ...
    // 5. Ubah UI
    const title = document.getElementById('titleRusak');
    const btn = document.getElementById('btnSubmitRusak');
    
    if (title) title.innerText = "Ubah Data Log Barang Rusak";
    if (btn) btn.innerText = "Perbarui Data Rusak";
